...
│   ├── PRD-{项目简称}-v1.0.md           # 需求文档（M1 产出）
│   ├── DESN-{项目简称}-v1.0.md          # 设计文档（M2 产出）
│   ├── CHK-{项目简称}-v1.0.md           # 一致性检查（M2 产出）
│   ├── QA-test-plan-{项目简称}-v1.0.md  # 测试计划（M2 产出）
│   ├── TEST-REPORT-{项目简称}-v1.0.md   # 测试报告（M4 产出）
│   ├── DEPLOY-TEST-{项目简称}-v1.0.md   # 部署测试报告（M5 产出）
│   └── CHANGELOG-{项目简称}.md          # 变更日志
├── src/                         # 源代码
├── tests/
...
| `/m4-test-api` | m4-test-kickoff 自动触发 | 执行 L1 API 测试 | `docs/QA-test-plan-{项目简称}-v1.0.md` |
| `/m4-test-e2e` | m4-test-api 完成后 | 执行 L2 E2E 测试 | `docs/QA-test-plan-{项目简称}-v1.0.md` |
...
| `/m6-retrospective` | 验收通过后 | BA+ARCH+TL 联合复盘 | `docs/CHANGELOG-{项目简称}.md` |
