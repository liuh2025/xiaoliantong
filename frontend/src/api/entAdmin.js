...
export const getMyOpportunities = (params) => request.get('/ent-admin/opportunities', { params })
export const updateMyOpportunity = (id, data) => request.put(`/ent-admin/opportunities/${id}`, data)
export const offlineMyOpportunity = (id) => request.put(`/ent-admin/opportunities/${id}/offline`)
export const republishMyOpportunity = (id) => request.put(`/ent-admin/opportunities/${id}/republish`)
